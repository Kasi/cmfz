...
!function (window, undefined) {
    ...
    b.clickToolbar(c, function () {
        ...
        var h, i,
                ...
                yesBtn: {
                    name: b.lang("yes"), click: function () {
                        var a = h.map, c = a.getCenter(), d = c.lng + "," + c.lat, g = a.getZoom(),
                            i = [o[0].checked ? b.pluginsPath + "baidumap/index.jsp" : "http://api.map.baidu.com/staticimage", "?center=" + encodeURIComponent(d), "&zoom=" + encodeURIComponent(g), "&width=" + e, "&height=" + f, "&markers=" + encodeURIComponent(d), "&markerStyles=" + encodeURIComponent("l,A")].join("");
            ...
            p = a('<iframe class="ke-textarea" frameborder="0" src="' + b.pluginsPath + 'baidumap/map.jsp" style="width:' + e + "px;height:" + f + 'px;"></iframe>');
...
}), KindEditor.plugin("map.jsp", function (a) {
    var b = this, c = "map.jsp", d = b.lang(c + ".");
    b.clickToolbar(c, function () {
        function e() {
